	...
	upsertPoints := []*pb.PointStruct{
		{
			...
			Payload: map[string]*pb.Value{
				"team": {
					Kind: &pb.Value_StringValue{StringValue: "Kings"},
				},
				"city": {
					Kind: &pb.Value_StringValue{StringValue: "Sacramento"},
				},
				"count": {
					...
					Kind: &pb.Value_ListValue{
						ListValue: &pb.ListValue{
							Values: []*pb.Value{
								...
								{
									Kind: &pb.Value_StringValue{StringValue: "Los Angeles"},
								},
							},
						},
					},
					...
					Kind: &pb.Value_ListValue{
						ListValue: &pb.ListValue{
							Values: []*pb.Value{
								...
								{
									Kind: &pb.Value_StringValue{StringValue: "New Orleans"},
								},
							},
						},
					},
